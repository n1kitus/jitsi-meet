...
public interface JitsiMeetViewListener {
     ...
     *
      ...
      *      If e.g. no "email" was set, that field will not show up at all.
     */
    void onEnterPictureInPicture(Map<String, Object> data);
    ...
    /**
      * Called when the current user was kicked out.
      *
      * @param data Map with a "url" key with the conference URL.
      */
    void onKickedOut(Map<String, Object> data);

    /**
      * Called immediately after the current user tapped hangup button but
      * before disconnecting.
      *
      * @param data Map with a "url" key with the conference URL.
      */
    void onConferenceHangup(Map<String, Object> data);
}
